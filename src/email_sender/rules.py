...
class EmailDecision:
    ...
    eta: Optional[pd.Timestamp]  # None for no_etd
...
def should_send_email_for_so(so_lines: pd.DataFrame) -> EmailDecision:
    ...
    # Rule: skip discontinued (line note starts with "dis")
